...
Additionally, I am developing a novel approach to enhance the resolution of the CGM in numerical simulations without simultaneously increasing the resolution of galaxies—an otherwise computationally expensive requirement. Using the massively parallel [GIZMO](http://www.tapir.caltech.edu/~phopkins/Site/GIZMO.html#:~:text=GIZMO%20is%20a%20flexible%2C%20massively,for%20the%20problem%20at%20hand).  code, this method allows for more realistic modeling of the spatial and dynamical structures in the CGM while maintaining computational efficiency.
